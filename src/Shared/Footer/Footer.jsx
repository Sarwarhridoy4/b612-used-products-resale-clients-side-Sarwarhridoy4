    ...
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <div>
                        <a href="/" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Used Mobile Deal</a>
                    </div>
        ...
        <div>
            <p class="text-center text-gray-500 dark:text-gray-400">© Used Mobile Deal 2022 - All rights reserved</p>
        </div>
    </div>
</footer>
        </div>
